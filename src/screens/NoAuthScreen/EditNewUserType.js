...
const EditNewUserType = ({ navigation, route }) => {
                    ...
                    .then(res => {
                        ...
                        if (res.data.response == true) {
                            ...
                            Toast.show({
                                type: 'success',
                                text1: '',
                                text2: "User type updated successfully.",
                                position: 'top',
    ...
    useEffect(() => {
        console.log(route.params.item, 'params')
        setFirstname(route.params.item.name)
        setSelectedItems(route.params.item.permission)
    }, [])
        ...
        <SafeAreaView style={styles.container}>
            <KeyboardAwareScrollView showsVerticalScrollIndicator={false} style={{ marginBottom: responsiveHeight(0) }}>
                <View style={{ paddingHorizontal: 20, paddingVertical: 25, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: responsiveFontSize(2.5), color: '#2F2F2F', marginLeft: responsiveWidth(5) }}>Edit User Type</Text>
                </View>
            ...
            <View style={styles.buttonwrapper}>
                ...
                <CustomButton label={"Edit User type"}
                    //onPress={() => { login() }}
                    onPress={() => { submitForm() }}
                />
            </View>
...
export default EditNewUserType;
